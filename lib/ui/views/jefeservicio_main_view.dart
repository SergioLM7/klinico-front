...
import 'servicekpis/service_kpis_dashboard.dart';
                    ...
                    child: Builder(
                      builder: (context) {
                        switch (_selectedIndex) {
                          ...
                          case 2:
                            return const ServiceKpisDashboard();
                          case 3:
...
class _GlassBottomNav extends StatelessWidget {
  ...
  static const _items = [
    (icon: Icons.list, label: 'Nuevos'),
    (icon: Icons.work_history, label: 'Carga'),
    (icon: Icons.analytics, label: 'KPIs'),
    (icon: Icons.person_add, label: 'Crear'),
    (icon: Icons.people, label: 'Ingresos'),
  ];
